...
> :warning: **Je bezpodmínečně nutné** nastavit účtu **uciteliw5@vutbr.cz** **access level** na **Visual Studio Subsriber** vždy po deadline odevzdání jednotlivých fází a den před obhajobou projektu. Tato změna současně vyžaduje, aby jednomu členu týmu byl na tuto nezbytnou dobu odebrán přístup ke kódu změnou **access levelu** z **Basic** na **Stakeholder**. Tento **access level** nám ponechte do doby, než dostanete hodnocení dané fáze.
