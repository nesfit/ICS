...
public static class RecipeSeeds
{
    ...
    public static readonly RecipeEntity RecipeEntityWithNoIngredients = RecipeEntity with { Id = Guid.Parse("98B7F7B6-0F51-43B3-B8C0-B5FCFFF6DC2E"), Ingredients = new List<IngredientAmountEntity>() };
    public static readonly RecipeEntity RecipeEntityUpdate = RecipeEntity with { Id = Guid.Parse("0953F3CE-7B1A-48C1-9796-D2BAC7F67868"), Ingredients = new List<IngredientAmountEntity>() };
    public static readonly RecipeEntity RecipeEntityDelete = RecipeEntity with { Id = Guid.Parse("5DCA4CEA-B8A8-4C86-A0B3-FFB78FBA1A09"), Ingredients = new List<IngredientAmountEntity>() };

    public static readonly RecipeEntity RecipeForIngredientAmountEntityUpdate = RecipeEntity with { Id = Guid.Parse("4FD824C0-A7D1-48BA-8E7C-4F136CF8BF31"), Ingredients = new List<IngredientAmountEntity>() };
