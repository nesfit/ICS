...
| 02.05. | L13 | Jan Pluskal     | [Multiplatformní programování](https://nesfit.github.io/ICS/Lectures/Lecture_10/_site/) - .NET Standard, .NET Core., .NET, kontejnerizace a deployment aplikací ([verze pro tisk](https://nesfit.github.io/ICS/Lectures/Lecture_10/_site/?print-pdf))                                        |
